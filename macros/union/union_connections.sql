{% macro pardot_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}

{{ adapter.dispatch('pardot_union_connections', 'pardot') (connection_dictionary, single_source_name, single_table_name, default_identifier) }}

{%- endmacro %}

{% macro default__pardot_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}
...
{# For unioning #}
    ...
    {%- if relations != [] -%}
        {{ pardot.pardot_union_relations(relations) }}
